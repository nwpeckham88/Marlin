...
#define STRING_CONFIG_H_AUTHOR "(KN8, SplEnder w/ BLT)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34.5, 33, -2.5 }
...
#define HOMING_FEEDRATE_MM_M { (40*60), (30*60), (4*60) }
